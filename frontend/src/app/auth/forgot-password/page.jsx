        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
          {sent ? (
            <div className="text-center">
              ...
              <h2 style={{ fontFamily: "'DM Serif Display',serif" }} className="text-2xl text-[#0B1D3A] mb-2">Check Your Email</h2>
            ...
            <>
              <h2 style={{ fontFamily: "'DM Serif Display',serif" }} className="text-2xl text-[#0B1D3A] mb-1">Forgot Password?</h2>
